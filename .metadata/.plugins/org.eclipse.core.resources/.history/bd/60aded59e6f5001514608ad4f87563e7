...
public class Peter implements Serializable
{
	...
	/*
	public void moveMe(int moveToX, int moveToY)
	{
	...
	*/
	...
	/*
	public int getNewX() { return this.moveToX; }
	public int getNewY() { return this.moveToY; }
	public void setNewX(int a) { this.moveToX = a; }
	public void setNewY(int a) { this.moveToY = a; }
